...
### Таблица Сессий
  ...
  * cookie - кука с которой пользователй залогинен
  * expiers - дата истечения действия куки
  * user_uid - пользователь который зашел с такой кукой

### Таблица файлов

  * owner_uid  - владелец файла
...
### Таблица прав доступа
  ...
  * user_uid - пользователь имеющий право
  * file_uid - файл к которому он имеет права
  * permisson - тип прав (чтение, редактировани)

### Таблица версий файлов

  * file_uid - файл к которому относится версия
  * user_uid - пользователь что загрузил версию (если меняет не владелец
  * s3_url - ссылка на s3 
  * uploaded - дата изменения
  * hash - хеш файла
