...
## Обеспечение надежности <a name="9"></a>

| Раздел                 | Обеспечение надёжности                                                                                      | 
| -----------------------| ------------------------------------------------------------------------------------------------------------| 
| Локальная балансировка | Несколько инстансов nginx, заменяющий друг друга при падении                                                |
| Tarantool              | Реприлицирование инстансов через Cartridge                                                                  |
| ClickHouse             | Использование внутреней системы реплицирования                                                              |
| S3 хранилище           | Репликация данных + расположение серверов в двух различных помещениях и соединение их "растянутым" кластером|
| PostgreSQL             | Мастер-мастер реприликация на запись, отдельные slave реплики на чтение, pgbouncer для раздачи коннектов к бекэндам|
| Бекэнды                | Горячее резервирование                                                                                      |


## Схема проекта <a name="10"></a>

![image](https://github.com/wergit13/highload-google-drive/assets/102697969/e362ff72-d12f-40ca-8e9c-af5c568955ed)

**Auth service** - отвечает за авторищацию пользователей
