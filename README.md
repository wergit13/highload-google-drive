...
| Загрузка на диск | 150 Tbit |
| Скачивание с диска | 300 Tbit |
...
| Балансировщик          | RPS           | Net         |CPU|RAM|
|------------------------|---------------|-------------|-|-|
| Main                   | 255_000       | 40 Tbit/s   |510|6 Gb|
| Download               | 510_000       | 81 Tbit/s   |1020|12Gb|

По [бенчмаркам](https://www.nginx.com/blog/testing-the-performance-of-nginx-and-nginx-plus-web-servers/) оптимальная конфигурация это 24 ядра на инстанс

Резервирование балансировщиков x2


#### Сервисы

| Сервис                 | Нагрузка, RPS | Net         |CPU|RAM|
|------------------------|---------------|-------------|-|-|
| Auth                   | 300           | 2 Mbit/s    |4| 1 GB |
| User                   | 210           | 1.5 Mbit/s  |4| 1 GB
| FileService            | 2500          | 40 Tbit/s   | 25| 4 GB |
| API Gateway            | 84_000        | 1 Gbit/s    |64| 1 GB|

Ререзервирование бекэендов x3

#### БД

| База Данных            | Нагрузка, RPS |  Net        |  RAM|  Drive|CPU|
|------------------------|---------------|-------------|-----|-------|-|
| Postgres               | 1500          | 20 Mbit/s   | 2 TB|  10 TB|16|
| User                   | 210           | 1.5 Mbit/s  |  700 GB  | 1TB  |4|
| Shards                 | 200           | 0.5 Mbit/s  | 128GB|  128GB |4|
| ACL                    | 230           | 0.5 Mbit/s  | 2 TB|  2TB  |4|
| Sessions               | 210           | 2 Mbit/s    |  128 GB | 128 GB |4|
| Clickhouse(Versions)   | 82_000        | 1.1 Gbit/s  |  128 GB  |  0.6 PB   |84|
| Clickhouse(Logs)       | 250_000       | 4 Gbit/s    |  64 GB  |  76 PB   | 250|
| S3                     | 700_000       | 120 Tbit/s  |  1 TB  |  8000 PB   |700|

 Объем расчитан на одну реплику и один ЦОД.
 Объем БД логов разчитан на храниение логов за 5 лет
